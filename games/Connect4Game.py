...
class Connect4Game(IGame):
    ...
    def __init__(self):
        ...
        self.gameState = Connect4GameState(np.array(
    ...
    def identities(self, state, actionValues):
        ...
        identities.append((Connect4GameState(currentBoard, state.playerTurn), currentAV))
        
        return identities


class Connect4GameState(IGameState):
    winners = [
        [0, 1, 2, 3],
        [1, 2, 3, 4],
        [2, 3, 4, 5],
    ...
    def isEndGame(self):
        ...
        return 1 if self.getWinner() != 0 else 0
